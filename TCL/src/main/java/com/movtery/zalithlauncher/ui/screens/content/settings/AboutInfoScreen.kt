            ...
            animatedItem(scope) { yOffset ->
                ChunkLayout(
                    ...
                    Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
                        ...
                        ButtonIconItem(
                            icon = painterResource(R.drawable.img_tcl_team),
                            title = "TCL Team",
                            text = "Author of TurboCraft Launcher",
                            button = {
                                Button(
                                    onClick = { openLink(URL_TCL) }
                                ) {
                        ...
                        ButtonIconItem(
                            icon = painterResource(R.drawable.img_tcl_team),
                            title = "Discord",
                            text = "If you'd like to join our Discord server, you're more than welcome to! We'd be happy to have you as part of our community.",
                            button = {
                                Button(
